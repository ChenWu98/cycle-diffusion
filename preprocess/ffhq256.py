...
class DevDataset(Dataset):
    ...
    def __init__(self, args, meta_args, raw_datasets, cache_root):
        ...
        self.root_dir = './data/images1024x1024'
        self.transform = transforms.Compose([
            transforms.Resize(256),  # Using the 256x256 version or follow the original processing.
            transforms.ToTensor()
        ])

        self.metas = []
        for i in [1]:  # For demo. You can use more images after downloading the dataset.
